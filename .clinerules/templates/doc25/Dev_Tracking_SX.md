...
- `[OBJ-{{SPRINT_ID}}-03] {{SPRINT_OBJECTIVE_3}}`
...
| To-Do | `ST-{{SPRINT_ID}}-03 - {{SPRINT_STORY_3}}` |
...
Registrar aqui apenas resumos e referencias cruzadas, por exemplo:

- `BUG-{{SPRINT_ID}}-01 - {{BUG_SUMMARY_1}} - ver tests/bugs_log.md`
- `TEST-{{SPRINT_ID}}-01 - {{TEST_SUMMARY_1}} - ver tests/bugs_log.md`
...
`ST-{{SPRINT_ID}}-03` | `{{TS_3_START}}` | `{{TS_3_FINISH}}` | `To-Do`
